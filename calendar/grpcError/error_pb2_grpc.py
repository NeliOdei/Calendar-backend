...
from grpcError import error_pb2 as error__pb2
...
class ErrorMethodStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendErrot = channel.unary_unary(
                ...
                request_serializer=error__pb2.AddError.SerializeToString,
                response_deserializer=error__pb2.Status.FromString,
                )
...
def add_ErrorMethodServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendErrot': grpc.unary_unary_rpc_method_handler(
                    servicer.SendErrot,
                    request_deserializer=error__pb2.AddError.FromString,
                    response_serializer=error__pb2.Status.SerializeToString,
            ),
    }
...
class ErrorMethod(object):
    ...
    def SendErrot(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/error_proto.ErrorMethod/SendErrot',
            error__pb2.AddError.SerializeToString,
            error__pb2.Status.FromString,
